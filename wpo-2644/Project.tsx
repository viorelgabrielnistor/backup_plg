  ...
  const copyProject = {
    ...
    notifications: {
      ...
      languageExpertNotifications: [
        ...project.notifications.languageExpertNotifications.map((elem, index) => {
          return { ...elem, languageThreshold: index ? index : ''  }
        })
      ]
    }
  }
              ...
              !values.workflows.includes(WORKFLOWS.SUPERVISED) ?
                ...
                : (
                  <>
                    ...
                    />
                    <h6 className={ `mb-3 ${ styles.notificationLabel }` }><FormattedMessage id="label.project.notificationsLEandMng" /></h6>
                    {
