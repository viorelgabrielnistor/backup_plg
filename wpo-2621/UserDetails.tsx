...
const UserDetails: FC<{}> = () => {
  ...
  const [selectedAccount, setSelectedAccount] = useState<{ label: string; value: USER_TYPE } | undefined>();
  ...
  const handleAuthenticationChange = () => {
    return (accountId: string): void => {
      const currentAccount = selectUserType.find(account => account.value === accountId)
      setSelectedAccount(currentAccount)
    }
  }
  const webhelpSelected = selectedAccount?.label === 'Webhelp';
                        ...
                        <Col md={ 4 }>
                          <div className="mb-4">
                            <Field
                              ...
                              isRequired = { !webhelpSelected }
                              isInvalid={ !webhelpSelected && !!touched.firstName && !!errors.firstName }
                            />
                          </div>
                          <div className="mb-4">
                            <Field
                              ...
                              isRequired = { !webhelpSelected }
                              isInvalid={ !webhelpSelected && !!touched.lastName && !!errors.lastName }
                            />
                          </div>
                          <div className="mb-4">
                            <Field
                              ...
                              isRequired = { !webhelpSelected }
                              isInvalid={ !webhelpSelected &&  !!touched.email && !!errors.email }
                            />
                          </div>
                          {userId !== id ? 
                            <div className="mb-4">
                        ...
                        <Col>
                          ...
                          <div className="mb-4 w-50">
                            <Field
                              ...
                              component={ CustomSelect }
                              handleOnChange={ handleAuthenticationChange() }
